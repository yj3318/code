...
function() {
    function n() {
        ...
        this.next = function() {
            n.activeCount--,
            n.queue.length > 0 && n.queue.shift()()
        }
    }
    function t() {
        this.request = [],
        ...
        this.push = function(n) {
            ...
            this.request.length >= 10 ? (this.request.shift(), this.request.push(n)) : this.request.push(n)
        },
    ...
    function i(n) {
        ...
        V = 0,
        W = n,
        F = n.query.ald_share_src,
        X = n.query.aldsrc || "",
        Y = n.query.ald_share_src,
        fn || ($ = !1),
        fn = !1,
        hn || (0 !== Q && Date.now() - Q > 3e4 ? (T = S(), N = Date.now()) : t && (N = Date.now(), T = S())),
        0 !== Q && Date.now() - Q < 3e4 && (rn = !0),
        n.query.ald_share_src && "1044" == n.scene && n.shareTicket ? wx.getShareInfo({
            shareTicket: n.shareTicket,
            success: function(n) {
                nn = n,
                D("event", "ald_share_click", JSON.stringify(n))
            }
        }) : n.query.ald_share_src && D("event", "ald_share_click", 1),
        "" === tn && wx.getSetting({
            withCredentials: !0,
            success: function(n) {
    ...
    function d(n) {
        ...
        return n.path = r + "ald_share_src=" + e.ald_share_src,
        D("event", "ald_share_status", n),
        n
    }
    function g() {
        function n() {
    ...
    function w(n) {
        ...
        n.et = Date.now(),
        n.st = Date.now(),
        H.useOpen ? "" === G ? pn.push(t) : (wx.Queue.push(t), pn.concat()) : wx.Queue.push(t)
    }
    function v() {
        var n = {};
    ...
    function y(n) {
        for (var t = "",
        e = 0; e < n.length; e++) n[e].length > t.length && (t = n[e]);
        return t
    }
    function S() {
    ...
    function A(n, t) {
        ...
        F && (e.usr = F),
        rn && (e.ps = 1),
        on || (cn = sn, on = !0, e.ifp = on, e.fp = sn),
        w(e)
    }
    function D(n, t, e) {
        var o = v();
    ...
    function I(n) {
        ...
        t.onError = function(t) {
            a.call(this, t),
            n.onError && "function" == typeof n.onError && n.onError.call(this, t)
        },
        t
    }
    function P(n) {
        ...
        t.onShow = function(t) {
            c.call(this),
            "function" == typeof n.onShow && n.onShow.call(this, t)
        },
        t.onHide = function(t) {
            f.call(this),
            "function" == typeof n.onHide && n.onHide.call(this, t)
        },
        ...
        t.onReachBottom = function(t) {
            p(),
            n.onReachBottom && "function" == typeof n.onReachBottom && n.onReachBottom.call(this, t)
        },
        t.onPullDownRefresh = function(t) {
            l(),
            n.onPullDownRefresh && "function" == typeof n.onPullDownRefresh && n.onPullDownRefresh.call(this, t)
        },
        n.onShareAppMessage && "function" == typeof n.onShareAppMessage && (t.onShareAppMessage = function(t) {
            ...
            return void 0 === e ? (e = {},
            e.path = this.route) : void 0 === e.path && (e.path = this.route),
            d.call(this, e)
        }),
        t
    }
    ...
    H.useOpen && console.warn("提示：开启了useOpen配置后，如果不上传用户opendId则不会上报数据。");
    var C = "7.3.0",
    U = "log",
    b = "wx",
    E = function() {
    ...
    try {
        ...
        en.pm = gn.model,
        en.pr = gn.pixelRatio,
        en.ww = gn.windowWidth,
        en.wh = gn.windowHeight,
        en.lang = gn.language,
        en.wv = gn.version,
        en.wvv = gn.platform,
        en.wsdk = gn.SDKVersion,
        en.sv = gn.system
    } catch(n) {}
    wx.getNetworkType({
        success: function(n) {
    ...
    o.prototype.sendEvent = function(n, t) {
        if ("" !== n && "string" == typeof n && n.length <= 255) if ("string" == typeof t && t.length <= 255) D("event", n, t);
    ...
    o.prototype.sendOpenid = function(n) {
        ...
        G = n,
        wx.setStorageSync("aldstat_op", n);
        var t = v();
        t.tp = "openid",
        t.ev = "event",
        t.ct = "openid",
    ...
    return H.plugin ? {
        ...
        function() {
            ...
            Page = function(n) {
                ...
                void 0 !== e && null !== e && (n.onShareAppMessage = function(n) {
                    if (void 0 !== e) {
                        var t = e.call(this, n);
                        return void 0 === t ? (t = {},
                        t.path = sn) : void 0 === t.path && (t.path = sn),
                        d(t)
                    }
                }),
                t(n)
                ...
                try {
                    ...
                    void 0 !== t && null !== t && (n.methods.onShareAppMessage = function(n) {
                        if (void 0 !== t) {
                            var e = t.call(this, n);
                            return void 0 === e ? (e = {},
                            e.path = sn) : void 0 === e.path && (e.path = sn),
                            d(e)
                        }
                    }),
                    e(n)
